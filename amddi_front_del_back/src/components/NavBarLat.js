...
export default function NavBarLat({ setIsLoggedIn, isAdmin, isAsesor, setIsAdmin, setIsAsesor }) {
    ...
    const handleLogout = async () => {
        try {
            const res = await axios.post('https://amddibackend-production-2880.up.railway.app/logoutA');
    ...
    useEffect(() => {
        ...
        if (token) {
            // Si el token existe, realiza una solicitud al servidor para obtener los datos del usuario
            axios.get('https://amddibackend-production-2880.up.railway.app/admin', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            })
                ...
                <ul className="navlat_list">
                    {isAdmin && (
                        ...
                        <Link to="" className={linkClass}>
                            <svg className="icon bi bi-house-door-fill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/tabla_usuarios" className={linkClass}>
                                    <svg className="icon bi bi-person-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/tabla_asesores" className={linkClass}>
                                    <svg className="icon bi bi-person-workspace" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/subir_archivo" className={linkClass}>
                                    <svg className="icon bi bi-cloud-arrow-up-fill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/asignar_usuario" className={linkClass}>
                                    <svg className="icon bi bi-diagram-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/asignar_servicio" className={linkClass}>
                                    <svg className="icon bi bi-wallet-fill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                                        <path d="M1.5 2A1.5 1.5 0 0 0 0 3.5v2h6a.5.5 0 0 1 .5.5c0 .253.08.644.306.958.207.288.557.542 1.194.542.637 0 .987-.254 1.194-.542.226-.314.306-.705.306-.958a.5.5 0 0 1 .5-.5h6v-2A1.5 1.5 0 0 0 14.5 2h-13z" />
                                        <path d="M16 6.5h-5.551a2.678 2.678 0 0 1-.443 1.042C9.613 8.088 8.963 8.5 8 8.5c-.963 0-1.613-.412-2.006-.958A2.679 2.679 0 0 1 5.551 6.5H0v6A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-6z" />
                                    </svg>
                                    <h5 className={opcionesClass} >Asignar Servicio</h5>
                                </Link>
                            </li>
                            <li>
                                <Link to="/servicio_especialidad" className={linkClass}>
                                    <svg className="icon bi bi-mortarboard" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
                    ...
                    {isAsesor && (
                        <>
                            <li>
                                <Link to="/asesorado_principal" className={linkClass}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" className="bi bi-person-hearts" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/asesorado_secundario" className={linkClass}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" className="bi bi-person-heart" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/asesorado_finalizado" className={linkClass}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" className="bi bi-person-arms-up" viewBox="0 0 16 16">
                        ...
                        <Link to="/mi_info" className={linkClass}>
                            <svg className="icon bi bi-info-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="currentColor" viewBox="0 0 16 16">
