...
export default function ServicioYEspecialidad() {
    ...
    const handleOk = async (id) => {
        ...
        try {
            ...
            await axios.put(`https://amddibackend-production-2880.up.railway.app/servicios/${id}`, {
    ...
    const handleOk2 = async (id) => {
        ...
        try {
            // Realiza la actualización del nombre del servicio
            await axios.put(`https://amddibackend-production-2880.up.railway.app/especialidades/${id}`, {
    ...
    //     try {
    //         const res = await axios.delete(`https://amddibackend-production-2880.up.railway.app/servicios/${id}`);
    ...
    //     try {
    //         const res = await axios.delete(`https://amddibackend-production-2880.up.railway.app/especialidades/${id}`);
    //         console.log('Asesor eliminado:', res.data.message);
    ...
    const handleServicio = async (event) => {
        ...
        try {
            const response = await fetch("https://amddibackend-production-2880.up.railway.app/servicios", {
                method: "POST",
                headers: {
                                ...
                                <tr key={servicio.id}>
                                    ...
                                    <td>
                                        {editingServiceId === servicio.id ? (
                                            ...
                                            <button onClick={() => handleEditar(servicio.id)}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fillRule="#00d799" className="bi bi-pencil-square" viewBox="0 0 16 16">
                            ...
                            {currentData2.map(especialidad => (
                                ...
                                <td>
                                    ...
                                    <td>
                                        {editingEspecialidadId === especialidad.id ? (
                                            <>
                                                <button onClick={() => handleOk2(especialidad.id)}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fillRule="#00d799" className="bi bi-check-circle" viewBox="0 0 16 16">
                                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                                    <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" />
                                                </svg></button>

                                                <button onClick={handleCancelar2}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fillRule="red" className="bi bi-x-circle" viewBox="0 0 16 16">
                                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                                    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                                                </svg></button>
                                            </>
                                        ) : (
                                            <button onClick={() => handleEditar2(especialidad.id)}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fillRule="#00d799" className="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                <path fillRule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                            </svg></button>
                                        )}
