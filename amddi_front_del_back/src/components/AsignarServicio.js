...
export default function MiInformacion() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://amddibackend-production-2880.up.railway.app/monto_pagado", formData);
            ...
            if (res.status === 200) {
                ...
                if (formData.id_servicio) {
                    ...
                    await axios.put(`https://amddibackend-production-2880.up.railway.app/usuario_servicio_estado/${formData.id_usuarios}/${formData.id_servicio}`)
                }
